...
* Performed multi-table **Joins** (INNER, LEFT) to consolidate customer profiles with transaction history.
* Developed **Database Views** to store reusable logic for frequently accessed reports (e.g., *Category Performance View*).
...
* **Tech Metrics:** Compared revenue contribution across different devices and payment gateways.
